...
export const demoInvoices: Invoice[] = [
  {
    ...
    line_items: [
      { description: 'Tile materials — 12x24 porcelain + mosaic accent', quantity: 1, unit_price: 1800, amount: 1800, type: 'product', unit: 'lot' },
      { description: 'Schluter waterproofing system', quantity: 1, unit_price: 450, amount: 450, type: 'product', unit: 'kit' },
      { description: 'Labor — demolition & prep (deposit)', quantity: 2, unit_price: 1000, amount: 2000, type: 'service', unit: 'days' },
    ],
  ...
  },
  {
    ...
    stripe_invoice_id: null,
    line_items: [
      { description: 'Labor — tile installation (balance)', quantity: 3, unit_price: 1000, amount: 3000, type: 'service', unit: 'days' },
      { description: 'Grout, caulk, and finishing materials', quantity: 1, unit_price: 350, amount: 350, type: 'product', unit: 'lot' },
      { description: 'Shower niche custom work', quantity: 1, unit_price: 900, amount: 900, type: 'service', unit: 'each' },
    ],
  ...
  },
  {
    ...
    stripe_invoice_id: null,
    line_items: [
      { description: 'Tile materials — marble-look porcelain + mosaic', quantity: 1, unit_price: 2200, amount: 2200, type: 'product', unit: 'lot' },
      { description: 'Linear drain supply & install', quantity: 1, unit_price: 600, amount: 600, type: 'product', unit: 'each' },
      { description: 'Labor — 4 days tile installation', quantity: 4, unit_price: 1000, amount: 4000, type: 'service', unit: 'days' },
    ],
  ...
  },
  {
    ...
    stripe_invoice_id: null,
    line_items: [
      { description: 'Marble tile — walls (large format)', quantity: 1, unit_price: 3500, amount: 3500, type: 'product', unit: 'lot' },
      { description: 'Pebble mosaic — shower floor', quantity: 1, unit_price: 800, amount: 800, type: 'product', unit: 'lot' },
      { description: 'Bench seat & niche fabrication', quantity: 1, unit_price: 1200, amount: 1200, type: 'service', unit: 'each' },
      { description: 'Labor — 9 days installation', quantity: 9, unit_price: 850, amount: 7650, type: 'service', unit: 'days' },
      { description: 'Change order — additional waterproofing', quantity: 1, unit_price: 50, amount: 50, type: 'product', unit: 'each' },
    ],
  ...
  },
  {
    ...
    stripe_invoice_id: null,
    line_items: [
      { description: 'Porcelain tile — 24x24 charcoal gray', quantity: 1, unit_price: 1400, amount: 1400, type: 'product', unit: 'lot' },
      { description: 'Floor prep & vinyl removal', quantity: 1, unit_price: 500, amount: 500, type: 'service', unit: 'each' },
      { description: 'Transition strip — tile to hardwood', quantity: 1, unit_price: 300, amount: 300, type: 'product', unit: 'each' },
      { description: 'Labor — 3 days installation', quantity: 3, unit_price: 667, amount: 2000, type: 'service', unit: 'days' },
    ],
  ...
  },
  {
    ...
    stripe_invoice_id: null,
    line_items: [
      { description: 'Tile repair materials', quantity: 1, unit_price: 400, amount: 400, type: 'product', unit: 'lot' },
      { description: 'Labor — estimated 3 days', quantity: 3, unit_price: 467, amount: 1400, type: 'service', unit: 'days' },
    ],
