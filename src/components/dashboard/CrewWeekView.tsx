...
import type { JobWithAssignee, Profile, CrewMember, CrewAssignment } from '@/lib/supabase/types'
                          ...
                          <div className="space-y-1">
                            {cellJobs.map((j) => (
                              <button
                                ...
                                className={`block w-full text-left truncate rounded px-1.5 py-1 text-[11px] font-medium leading-tight ${jobStatusMeta(j.status).chip} hover:opacity-80`}
                                title={j.title}
                              >
                                {j.title}
                              </button>
                        ...
                        <div className="space-y-1">
                          {cellAssignments.map((a) => {
                            ...
                            return (
                              <div
                                key={a.id}
                                className={`group flex items-center gap-1 rounded px-1.5 py-1 text-[11px] font-medium leading-tight ${jobStatusMeta(status).chip}`}
                                title={job?.title ?? 'Job'}
                              >
                                <button
